...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="{{ url('assets/images/logo/logo.svg') }}
                " alt="Logo" srcset=""></a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item  ">
                <a href="{{ url('alternatif') }}" class='sidebar-link'>
                    <i class="bi bi-grid-fill"></i>
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        <svg class="bi text-primary" width="32" height="32" fill="blue"
                                            style="width:10px">
                                            <use
                                                xlink:href="{{ url('assets/images/bootstrap-icons.svg#circle-fill') }}" />
                                        </svg>
            ...
            <div class="card">
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 name">
                            <h5 class="font-bold">Ambatukam</h5>
                            <h6 class="text-muted mb-0">@siimut</h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ url('assets/images/faces/4.jpg') }}">
                        </div>
                        <div class="name ms-4">
                            <h5 class="mb-1">pelan pelan pak supir</h5>
                            <h6 class="text-muted mb-0">@paksupir</h6>
                        </div>
                    </div>
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                        ...
                        <div class="name ms-4">
                            <h5 class="mb-1">Bang Messi</h5>
                            <h6 class="text-muted mb-0">@artinyaapabangmessi</h6>
                        </div>
                    </div>
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                        ...
                        <div class="name ms-4">
                            <h5 class="mb-1">Hafif Mullet</h5>
                            <h6 class="text-muted mb-0">@karnayangmullet</h6>
                        </div>
                    </div>
                    <div class="px-4">
