            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ url('/product/'.$data->id) }}" method="post" class="form">
                                @csrf
                                @method('put')
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control"
                                                name="size" placeholder="Size" value="{{$data->size}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="company-column">Age Rating</label>
                                            <input type="text" id="company-column" class="form-control"
                                                name="rating" placeholder="age rating" value="{{$data->age_rating}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">Review</label>
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="review" placeholder="Review" value="{{$data->name}}">
                                        </div>
                                    </div>
