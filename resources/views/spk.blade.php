...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <section class="table-data container mb-5 mt-5">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="ps-3">{{$item->alternatif }}</td>
                                                    <td>{{$C1min['alternatif'] / $item->harga}}</td>
                                                    <td>{{$item->rate_umur / $C2max['alternatif']}}</td>
                                                    <td>{{$item->size / $C3max['alternatif']}}</td>
                                                    <td>{{$C4min['alternatif'] / $item->review}}</td>
                                                    <td>{{$item->user_download / $C5max['alternatif']}}</td>
                                ...
                                <div class="card-content mt-3">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th class="ps-3">Game Online Terbaik</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="ps-3">{{$item->alternatif}}</td>
                                                    <td>
                                                        {{(($C1min['alternatif'] / $item->harga)*$widget1['kriterias'])+
                                            (($item->rate_umur / $C2max['alternatif'])*$widget2['kriterias'])+
                                            (($item->review / $C3max['alternatif'])*$widget3['kriterias'])+
                                            (($C4min['alternatif'] / $item->size)*$widget4['kriterias'])+
                                            (($item->user_download / $C5max['alternatif'])*$widget5['kriterias'])}}
                                                    </td>
                                                </tr>
